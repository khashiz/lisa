...
<?php if ($pageclass != 'auth') { ?>
    <header class="uk-box-shadow-large uk-background-muted uk-padding uk-padding-remove-horizontal uk-padding-remove-bottom uk-position-relative uk-background-center-center uk-background-cover <?php echo $pageclass; ?>" style="background-image: url('<?php echo $pageparams->get('headerbg') ? (HTMLHelper::cleanImageURL($pageparams->get('headerbg')))->url : (HTMLHelper::cleanImageURL($params->get('default_header_bg')))->url; ?>');">
        <div class="uk-container uk-position-relative">
                ...
                <div class="uk-container">
                    <div class="uk-grid-small" data-uk-grid>
                        <div class="uk-width-1-5 uk-hidden@s uk-flex uk-flex-middle">
                            <a href="#hamMenu" data-uk-toggle class="uk-border-rounded uk-flex uk-link-reset"><i class="far fa-bars fa-fw fa-2x"></i></a>
                        </div>
                        <div class="uk-width-1-5 uk-flex uk-flex-middle uk-flex-center">
                            <a href="<?php echo JUri::base(); ?>" title="<?php echo $sitename; ?>" class="uk-display-inline-block logo"><img src="<?php echo JUri::base().'images/logo.png'; ?>" width="50" height="50" alt="<?php echo $sitename; ?>" data-uk-svg></a>
                        </div>
                        <div class="uk-width-expand uk-flex uk-flex-center"><jdoc:include type="modules" name="nav" style="html5" /></div>
                        <div class="uk-width-1-5 uk-flex uk-flex-middle uk-flex-left">
                            <div class="uk-child-width-auto uk-grid-divider uk-grid-small" data-uk-grid>
                                <div class="uk-width-auto">
                                    <a class="uk-button uk-button-secondary uk-border-rounded uk-box-shadow-small uk-button-small uk-animation-slide-right-small">رزرو نوبت مشاوره</a>
                                </div>
            ...
            <div class="search" hidden><jdoc:include type="modules" name="search" style="html5" /></div>
        ...
        <div class="<?php echo $pageparams->get('gridsize', '') ?>">
            <div class="uk-grid-divider" data-uk-grid>
                ...
                <article class="uk-width-1-1 uk-width-expand@m">
                    <div class="uk-hidden"><jdoc:include type="message" /></div>
                    ...
                    <div class="uk-position-relative particles">
                        ...
                        <div class="uk-grid-large uk-child-width-1-5 uk-flex-between" data-uk-grid>
                            <div class="uk-width-1-1 uk-width-1-4@s">
                                <h5><?php echo JText::_('FULL_TITLE'); ?></h5>
                                <p class="font text uk-text-small"><?php echo JText::_('FOOTER_TEXT'); ?></p>
