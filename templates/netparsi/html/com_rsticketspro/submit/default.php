...
echo '<div class="uk-hidden">'.$this->form->getField('email')->renderField(array('class' => 'rst_email_container')).'</div>';
echo '<div class="uk-hidden">'.$this->form->getField('name')->renderField(array('class' => 'rst_name_container')).'</div>';
...
?>
	<div>
		<button type="button" class="uk-button uk-button-secondary uk-button-large uk-width-1-1 uk-border-pill uk-box-shadow-small" onclick="Joomla.submitbutton('submit.save'); this.disabled = true;"><?php echo JText::_('RST_SUBMIT_REQUEST'); ?></button>
	</div>
    </div>
