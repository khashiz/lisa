...
if ($this->params->get('show_headings', 1))
{
	...
	<thead>
		...
		{
			?>
			<th id="rst_head_date" nowrap="nowrap" class="uk-width-auto uk-text-center uk-text-tiny font f500 uk-text-muted">
		...
		{
			?>
			<th id="rst_head_last_reply" nowrap="nowrap" class="uk-width-auto uk-text-center uk-text-tiny font f500 uk-text-muted">
