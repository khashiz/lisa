...
<?php endif; ?>
	<div class="mod-login-logout__button logout-button">
		<button type="submit" name="Submit" class="uk-button uk-button-danger uk-button-large uk-border-pill uk-box-shadow-small uk-width-1-1"><?php echo Text::_('JLOGOUT'); ?></button>
