...
<div class="uk-child-width-1-1 uk-grid-divider com-content-category-blog blog" itemscope itemtype="https://schema.org/Blog" data-uk-grid>
	...
	<?php if (!empty($this->lead_items)) : ?>
        <div>
            <div class="uk-child-width-1-1 uk-child-width-1-3@s com-content-category-blog__items blog-items items-leading <?php echo $this->params->get('blog_class_leading'); ?>" data-uk-grid data-uk-scrollspy="cls: uk-animation-slide-bottom-small; target: > *; delay: 250;">
