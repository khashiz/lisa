...
<div class="uk-padding-large uk-padding-remove-horizontal">
    <div class="uk-container">
        <div class="uk-text-center uk-margin-large-bottom">
            <h1 class="font f700 uk-text-primary uk-margin-remove uk-h3"><?php echo $fieldsValue['catmaintitle']; ?></h1>
            <p class="uk-margin-remove-bottom uk-margin-top font f500"><?php echo $fieldsValue['catmaintext']; ?></p>
        </div>
<div class="uk-child-width-1-1 uk-grid-divider com-content-category-blog blog" itemscope itemtype="https://schema.org/Blog" data-uk-grid>
	...
	<?php if (!empty($this->lead_items)) : ?>
        <div>
            <div class="uk-child-width-1-1 uk-child-width-1-4@s com-content-category-blog__items blog-items items-leading <?php echo $this->params->get('blog_class_leading'); ?>" data-uk-grid data-uk-scrollspy="cls: uk-animation-slide-bottom-small; target: > *; delay: 250;">
