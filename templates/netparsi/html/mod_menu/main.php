...
<?php foreach ($list as $i => &$item)
{
	...
	if ($item->deeper)
	{
		echo '<div data-uk-drop="animation: uk-animation-slide-bottom-small; offset: 0;"><div class="uk-box-shadow-small subMenuWrapper"><ul class="mod-menu__sub list-unstyled small">';
	}
