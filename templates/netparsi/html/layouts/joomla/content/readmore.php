...
<div class="readmore">
	...
	<?php elseif ($params->get('show_readmore_title', 0) == 0) : ?>
		<a class="font f500 uk-position-relative uk-display-inline-block uk-text-small readmore" href="<?php echo $displayData['link']; ?>" aria-label="<?php echo Text::sprintf('JGLOBAL_READ_MORE_TITLE', $this->escape($item->title)); ?>">
            <?php echo '<span>'.Text::_('JGLOBAL_READ_MORE').'</span><i class="fas fa-chevron-' . $direction . '"></i>'; ?>
        </a>
	<?php else : ?>
