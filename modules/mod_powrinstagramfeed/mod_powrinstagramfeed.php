<?php
/**
* Joomla! POWr Instagram Feed
*
* @version 2.0
* @author POWr.io
* @package POWr Instagram Feed
* @subpackage POWr
      ...
      public function add_powr_js(){
        ...
        if($POWR_JS_ADDED){
          return;
		    ...
		    $js_url = JURI::base()."modules/mod_powrinstagramfeed/powr_joomla.js";
        $js = "(function(d){
...
//Create Helper
new PowrHelper();
echo "<div class='powr-instagram-feed' label='joomla_$module->id'></div>";
?>