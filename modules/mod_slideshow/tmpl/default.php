...
?>
<section class="uk-position-relative slideshowWrapper">
    <div class="uk-margin-large-bottom uk-position-relative slideshow">
        <div class="uk-position-relative uk-visible-toggle" tabindex="-1" data-uk-slideshow="animation: slide; ratio: 3:1; autoplay: true; autoplay-interval: 4000; min-height: 300;" id="<?php echo $modId; ?>">
            ...
            <span class="uk-position-center-left uk-padding slideshowArrow uk-text-secondary cursorPointer uk-visible@s" data-uk-slideshow-item="previous"><i class="fal fa-fw fa-2x fa-chevron-left"></i></span>
            <span class="uk-position-center-right uk-padding slideshowArrow uk-text-secondary cursorPointer uk-visible@s" data-uk-slideshow-item="next"><i class="fal fa-fw fa-2x fa-chevron-right"></i></span>
